...
//   return (
//     <div>
//         <div className="bestCard flex justify-between items-center p-7 text-gray-400">
//             {lilCard.map(({ img, name, desc, rating, review }, index) => (
...
//                 {[...Array(5)].map((_, i) => (
//                     <i key={i} className={`ri-star-fill text-yellow-400 text-lg ${i < rating ? "text-yellow-400" : "text-gray-300"}`}></i>
//                 ))}
